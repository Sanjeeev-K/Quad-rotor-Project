bag = rosbag('la_s_z_2019-10-29-14-58-01.bag');
...
plot(time_command,z_command,'LineWidth',4);
hold on;
plot(time_pose, z_pose,'LineWidth',4);
hold on;

title('Step Response','Interpreter','latex')
ylabel({'$z (m)$'},'Interpreter','latex','Rotation',0,'HorizontalAlignment','Right');
